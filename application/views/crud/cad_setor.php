...
<div class="container">
    <div class="col-sm-10" style="margin-left: 200px; margin-top: -20px;">
        ...
        <div class="row">
            <form role="form" method="post" action="<?= base_url('setor/incluir') ?>">
                <h3>Cadastrar <small>Setor</small></h3>
                <hr class="colorgraph">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <select name="idEmpresa" id="marca" class="form-control" required style="width: 100%;">
